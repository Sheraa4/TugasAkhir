...
<main class="container mx-auto my-10 pt-20">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div class="flex justify-center">
            <img src="{{ asset('img/outer4.svg') }}" class="w-[450px] h-[500px] object-cover rounded-md" alt="Shearling Warm Coat">
        </div>

        <!-- Detail Produk -->
        <div class="pr-44">
            <h2 class="text-2xl font-bold mb-2">Shearling Warm Coat</h2>
            <p class="text-gray-600 mb-4">
            Mantel berbahan kulit sintetis dengan lapisan shearling lembut yang hangat, sempurna untuk cuaca dingin atau gaya kasual chic.
            </p>
            <p class="text-2xl text-red-500 font-medium mb-6">IDR 700.000</p>
