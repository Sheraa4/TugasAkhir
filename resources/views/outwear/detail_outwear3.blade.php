...
<main class="container mx-auto my-10 pt-20">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div class="flex justify-center">
            <img src="{{asset('img/outer3.svg') }}" class="w-[450px] h-[500px] object-cover rounded-md" alt="Blush Bow Cardigan">
        </div>

        <!-- Detail Produk -->
        <div class="pr-44">
            <h2 class="text-2xl font-bold mb-2">Blush Bow Cardigan</h2>
            <p class="text-gray-600 mb-4">
            Cardigan rajut warna pastel dengan detail pita manis di bagian leher, memberikan kenyamanan dan gaya feminin yang santai.
            </p>
            <p class="text-2xl text-red-500 font-medium mb-6">IDR 350.000</p>
