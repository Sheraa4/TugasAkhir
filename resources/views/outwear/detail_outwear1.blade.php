...
<main class="container mx-auto my-10 pt-20">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div class="flex justify-center">
            <img src="{{ asset('img/outer1.svg') }}" class="w-[450px] h-[500px] object-cover rounded-md" alt="Aurora Textured Jacket">
        </div>

        <!-- Detail Produk -->
        <div class="pr-44">
            <h2 class="text-2xl font-bold mb-2">Aurora Textured Jacket</h2>
            <p class="text-gray-600 mb-4">
            Jaket dengan desain crop berbahan kain tekstur yang mewah, dilengkapi lengan balon yang memberikan tampilan anggun namun tetap modern. Cocok untuk acara formal atau semi-formal.
            </p>
            <p class="text-2xl text-red-500 font-medium mb-6">IDR 450.000</p>
            ...
            <p class="mt-4 text-gray-600">
                Kategori: <span class="font-semibold">Outwear</span>
            </p>
        </div>
    </div>
</main>
