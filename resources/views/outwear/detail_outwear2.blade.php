...
<main class="container mx-auto my-10 pt-20">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div class="flex justify-center">
            <img src="{{ asset('img/outwe2.svg') }}" class="w-[450px] h-[500px] object-cover rounded-md" alt="Noir Luxe Blazer">
        </div>

        <!-- Detail Produk -->
        <div class="pr-44">
            <h2 class="text-2xl font-bold mb-2">Noir Luxe Blazer</h2>
            <p class="text-gray-600 mb-4">
            Blazer pendek berbahan kulit sintetis berkualitas dengan potongan klasik, memberikan kesan modern dan stylish. Ideal untuk tampilan profesional.
            </p>
            <p class="text-2xl text-red-500 font-medium mb-6">IDR 650.000</p>
