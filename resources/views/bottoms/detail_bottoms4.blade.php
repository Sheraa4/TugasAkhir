...
<main class="container mx-auto my-10 pt-20">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div class="flex justify-center">
            <img src="{{ asset('img/bottom4.svg') }}" class="w-[450px] h-[600px] object-cover rounded-md" alt="Denim Bold Skirt">
        </div>

        <!-- Detail Produk -->
        <div class="pr-44">
            <h2 class="text-2xl font-bold mb-2">Denim Bold Skirt</h2>
            <p class="text-gray-600 mb-4">
            Rok jeans modern dengan slit minimalis. Sempurna untuk tampil kasual dengan nuansa urban yang trendi.
            </p>
            <p class="text-2xl text-red-500 font-medium mb-6">IDR 395.000</p>
