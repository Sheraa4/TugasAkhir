...
@section('content')
        ...
        <!-- <div class="col-md-6">
            <h2 class="fw-bold">White Harmony Blouse</h2>
            <p class="text-muted">Blus putih dengan detail renda halus dan kerah tinggi. Memberikan kesan anggun untuk gaya formal atau semi-formal.</p>
            <p class="fs-4 text-danger">IDR 385.000</p> -->
...
<main class="container mx-auto my-10 pt-20">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div class="flex justify-center">
            <img src="{{ asset('img/TOPS4.svg') }}" class="w-[450px] h-[500px] object-cover rounded-md" alt="White Harmony Blouse">
        </div>
        <!-- Detail Produk -->
        <div class="col-md-6">
            <h2 class="text-2xl font-bold mb-2">White Harmony Blouse</h2>
            <p class="text-gray-600 mb-4">Blus putih dengan detail renda halus dan kerah tinggi. Memberikan kesan anggun untuk gaya formal atau semi-formal.</p>
            <p class="text-2xl text-red-500 font-medium mb-6">IDR 385.000</p>    
        <!-- Ukuran -->
            <div class="mb-6">
