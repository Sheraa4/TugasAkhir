...
<main class="container mx-auto my-10 pt-20">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div class="flex justify-center">
            <img src="{{ asset('img/tos1.svg') }}" class="w-[450px] h-[500px] object-cover rounded-md" alt="Blouse Serenity Classic">
        </div>

        <!-- Detail Produk -->
        <div class="pr-44">
            <h2 class="text-2xl font-bold mb-2">Blouse Serenity Classic</h2>
            <p class="text-gray-600 mb-4">
            Atasan krem elegan dengan detail lengan menggembung dan kerut di bagian bawah. Pas untuk gaya vintage modern yang simpel.
            </p>
            <p class="text-2xl text-red-500 font-medium mb-6">IDR 299.900</p>
