...
<!-- 
        <div class="col-md-6">
            <h2 class="fw-bold">Classic Charm</h2>
            <p class="text-muted">Sepatu flat putih dengan aksen pita di bagian depan, memberikan kesan simpel namun manis. Ideal untuk digunakan sehari-hari dengan gaya kasual atau semi-formal.</p>
            <p class="fs-4 text-danger">IDR 469.900</p> -->
...
<main class="container mx-auto my-10 pt-20">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div class="flex justify-center">
            <img src="{{ asset('img/shoes1.jpg') }}" class="w-[450px] h-[500px] object-cover rounded-md" alt="Blouse Serenity Classic">
        </div>
        <!-- Detail Produk -->
        <div class="col-md-6">
            <h2 class="text-2xl font-bold mb-2">Blouse Breeze Charm</h2>
            <p class="text-gray-600 mb-4">Sepatu balerina dengan aksen pita manis dan desain klasik yang nyaman. Cocok untuk gaya kasual maupun semi-formal.</p>
            <p class="text-2xl text-red-500 font-medium mb-6">IDR 250.000</p>    
        <!-- Ukuran -->
            <div class="mb-6">
