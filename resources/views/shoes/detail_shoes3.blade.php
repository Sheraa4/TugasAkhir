...
<!-- 
            ...
            <h2 class="fw-bold">Midnight Luxe</h2>
            <p class="text-muted">Sepatu hak rendah berwarna hitam dengan detail rantai emas. Memberikan kesan classy dan bold, pas untuk acara formal atau tampilan malam
            </p>
            <p class="fs-4 text-danger">IDR 389.000</p> -->
