...
<main class="container mx-auto my-10 pt-20">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div class="flex justify-center">
            <img src="{{ asset('img/dress2.svg') }}" class="w-[450px] h-[600px] object-cover rounded-md" alt="White Ruffle Charm Dress">
        </div>

        <!-- Detail Produk -->
        <div class="pr-44">
            <h2 class="text-2xl font-bold mb-2">White Ruffle Charm Dress</h2>
            <p class="text-gray-600 mb-4">
            Gaun putih beraksen ruffle ini memancarkan kesan feminin klasik dengan gaya bertingkat yang elegan. Cocok untuk momen spesial yang membutuhkan sentuhan romantis dan menawan.
            </p>
            <p class="text-2xl text-red-500 font-medium mb-6">IDR 399.000</p>
