...
<main class="container mx-auto my-10 pt-20">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div class="flex justify-center">
            <img src="{{ asset('img/dress4.svg') }}" class="w-[450px] h-[600px] object-cover rounded-md" alt="Blush Romantic Maxi">
        </div>

        <!-- Detail Produk -->
        <div class="pr-44">
            <h2 class="text-2xl font-bold mb-2">Blush Romantic Maxi</h2>
            <p class="text-gray-600 mb-4">
            Gaun maxi berwarna merah muda lembut ini memberikan kesan manis dengan potongan lengan puff dan aksen pita kecil di dada. Desainnya yang sederhana namun elegan cocok untuk berbagai kesempatan.
            </p>
            <p class="text-2xl text-red-500 font-medium mb-6">IDR 479.900</p>
            ...
            <p class="mt-4 text-gray-600">
                Kategori: <span class="font-semibold">Dress</span>
            </p>
        </div>
    </div>
</main>
