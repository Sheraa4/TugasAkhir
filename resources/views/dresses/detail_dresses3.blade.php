...
<main class="container mx-auto my-10 pt-20">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div class="flex justify-center">
            <img src="{{ asset('img/dress3.svg') }}" class="w-[450px] h-[600px] object-cover rounded-md" alt="Blue Victorian Bow Dress">
        </div>

        <!-- Detail Produk -->
        <div class="pr-44">
            <h2 class="text-2xl font-bold mb-2">Blue Victorian Bow Dress</h2>
            <p class="text-gray-600 mb-4">
            Gaun biru pastel dengan detail renda dan pita hitam ini menggabungkan gaya vintage dengan modern. Ideal untuk tampilan yang unik dan elegan di acara santai atau semi-formal.
            </p>
            <p class="text-2xl text-red-500 font-medium mb-6">IDR 389.000</p>
