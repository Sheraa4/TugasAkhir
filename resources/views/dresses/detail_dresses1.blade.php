...
<main class="container mx-auto my-10 pt-20">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div class="flex justify-center">
            <img src="{{ asset('img/dress1.svg') }}" class="w-[450px] h-[600px] object-cover rounded-md" alt="White Bow Midi Dress">
        </div>

        <!-- Detail Produk -->
        <div class="pr-44">
            <h2 class="text-2xl font-bold mb-2">White Bow Midi Dress</h2>
            <p class="text-gray-600 mb-4">
            Midi dress elegan dengan detail pita di bahu, cocok untuk acara formal atau semi-formal. Potongan fit and flare yang anggun memberikan kesan feminin.
            </p>
